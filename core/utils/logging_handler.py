...
class LoggingHandler:
    """
    Backward compatibility wrapper for the logging system
    """
    
    def __init__(self, log_level: str = "INFO", log_file: Optional[str] = None):
        """Initialize the logging handler with default configuration"""
        self.log_level = log_level
        self.log_file = log_file
    
    def get_logger(self, name: str = __name__) -> logging.Logger:
        """Get a logger instance - wrapper for get_logger function"""
